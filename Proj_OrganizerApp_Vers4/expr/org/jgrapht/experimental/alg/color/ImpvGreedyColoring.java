...
public class ImpvGreedyColoring<V, E>
    ...
    implements ApproximationAlgorithm<Integer, V>
{
     ...
     * @param g
     */
    public ImpvGreedyColoring(final Graph<V, E> g)
    {
        this(g, BEST_ORDER);
    }
     ...
     * @param g
     */
    public ImpvGreedyColoring(final Graph<V, E> g, final int method)
    {
        super(g);
        _order = method;
    }
	...
	@Override
	public Integer getUpperBound(Map<V, Object> arg0) {
